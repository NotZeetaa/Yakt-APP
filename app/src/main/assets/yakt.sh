...
write_value() {
    ...
    # Read current value
    old_value=$(cat "$file_path" 2>/dev/null)
...
# Function to apply Balanced profile
apply_balanced() {
...
# Function to apply Battery profile
apply_battery() {
...
# Function to apply Gaming profile
apply_gaming() {
...
# Function to apply Latency profile
apply_latency() {
...
echo "Profile '$1' applied successfully. Check $INFO_LOG for details."